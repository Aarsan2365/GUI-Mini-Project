            ...
            <div class="mt-auto border-t border-zinc-100 dark:border-zinc-800 pt-10">
              ...
              <div class="flex gap-4">
                <button 
                  ...
                  class="flex-1 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-bold py-4 px-8 rounded-2xl transition-all hover:scale-[1.02] shadow-xl hover:shadow-2xl flex items-center justify-center gap-2 text-lg">
