    ...
    <div class="container px-4 mx-auto h-20 flex items-center justify-between gap-6">
      ...
      <div class="flex items-center gap-3">
        ...
        >
           ...
           <!-- Badge -->
           <span v-if="store.cartCount.value > 0" class="absolute -top-1 -right-1 bg-violet-600 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full shadow-sm animate-in zoom-in">
             {{ store.cartCount.value }}
           </span>
        </button>
